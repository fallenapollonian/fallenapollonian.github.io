...
**Political liberals are also more likely to endorse consequentialism when the victim in question is white rather than black, which suggests that liberals are more sensitive to sacrificing black people when compared to white people.**
...
**The research on police use of force bias is all over the place, and this could be due to variation in research methods or variation in the actual phenomenon studied. Needless to say, the evidence is not 100% clear. Despite all of this, in my assessment, there is no disparity in police use of force conditional upon encounter. There does appear to be a disparity in police use of force once the initial probability of an encounter is taken into account. That is to say, police are not more likely to shoot a black person in a police encounter compared to a white person. However, once taking into account the probability of a police encounter occurring, there is a disparity.**

**Research looking at police use of force as a function of crime rates can help assess whether racial bias is at play. There appears to be an anti-white bias overall in this respect, although the picture becomes more nuanced when looking at unarmed vs armed civilian deaths. There is an anti-white bias when it comes to police exerting force on armed civilians, while there is an anti-black bias when it comes to police exerting force on unarmed civilians. Therefore, the picture is complex and it is unclear whether police use of force is on the net anti-white or anti-black.**

**It does appear though that a lot of the narrative around extensive police killings of unarmed black people decreases the mental health of black people.**
...
-   Finds that there is high variation in findings of police use of force studies, even in laboratory settings. The variations could reflect variation in the actual phenomenon across agencies or geographic areas, or could reflect different research methods used to study the same phenomenon.
...
-   Among black men, police use of force is one of the leading causes of death
...
-   Finds that police-related death rates are highest among neighborhoods which are lower in income and which have a higher proportion of residents of color there.

</details>

<details markdown="1">
  <summary>Experimental Shooting Studies</summary>

**The overall evidence according to meta-analysis suggests that there is a lower shooting threshold for black targets, although this is experimental and thus may not translate into real-world behavior.**

[The Reverse Racism Effect Are Cops More Hesitant to Shoot Black Than White Suspects?](https://media.spokesman.com/documents/2016/05/The_Reverse_Racism_Effect.pdf)

-   Experiment

-   Finds that while there is clear evidence of an implicit bias against black suspects by police, officers were slower to shoot armed black suspects than white suspects and less likely to shoot unarmed black suspects than unarmed white suspects.

[Is the evidence from racial bias shooting task studies a smoking gun? Results from a meta-analysis](https://www.sciencedirect.com/science/article/abs/pii/S0022103115000992)
...
<details markdown="1">
  <summary>Use of Force Within Encounter</summary>

**Within an encounter the overall evidence suggests that there is no racial bias on the decision to shoot a suspect, as is shown with meta-analytic evidence.**
...
-   There are a number of narrative reviews on the subject of use of force decisions by American police officers

-   However, there is a reliance on professional expertise to draw valid conclusions in the case of contradictory results between studies. This can cause different conclusions to be reached by different authors even when presented with the same literature set.

-   Study is a meta-analysis of 44 separate analyses from 19 articles.

-   The literature overall suggests an inconsistent relationship between race and use of force, with most research suggesting it's null overall and some suggesting it's an anti-black effect

-   Officer race also appears to have no effect on use of force

-   Exclusion criteria of studies following literature search:     

-   "The first requirement is that studies must have been published between 1995 and 2013."

-   "Second, only studies that included patrol officers as the sample under study were used." (As opposed to detectives)

-   "Third, sufficient statistical information was needed to allow for the calculation of an effect size."

-   "Fourth, studies that measured use of force through a "force factor" were excluded. These measures incorporate suspect resistance into the dependent variable and are thus substantively different from the focus of this study. This is not a judgment of whether use of force research should include suspect as an independent variable or within the dependent variable, but it is a judgment that including these studies would contribute to the potential violation of the homogeneity assumption of meta-analyses. Furthermore, including force factor studies would introduce an independent variable of the present analysis as part of the dependent variable. Doing so would render the present analysis non-recursive."  

-   "Fifth, the collected data must have been at the micro level---data collected at the encounter or suspect level. Only those studies that recorded officer decisions during encounters with citizens were included. Studies that were excluded due to this requirement measured use of force in a variety of manners; including hypothetical vignettes, citizen attitudes regarding use of force decisions, and simulated training environments. All of these are conceptually distinct from decisions made in the field."

-   "Sixth, studies that included a sample where all encounters involved use of force were excluded. Much of the same logic applied for excluding force factor studies also applies here. Studies that only include encounters where force was used by an officer are distinct from studies that include all encounters between officers and citizens. This truncates the dependent variable, and including these studies would again inflate heterogeneity issues." 

-   "Seventh, only multivariate tests were included to reduce the chance of including studies that may be misspecified. If a study only included a single explanatory variable, there is a substantial chance that the finding is spurious. Research on use of force, and police decision-making in general, has long since moved beyond these relatively simple methodological designs."

-   "Nineteen studies met all of these criteria."

-   To adjust for publication bias, trim-and-fill was used. Before, race was a significant predictor, but afterwards it lost significance. 

-   "Unfortunately, who the suspect is also appears to play a role in use of force decisions. Suspects who are minorities, males, and/or lower class are more likely to have force used against them. Obviously, it is inappropriate for officers to base coercive decisions upon suspects' demographic characteristics, but these results follow Kochel et al.'s (2011) finding that race plays a significant, but relatively minor role in officer decision-making."

-   "Of the variables that were shown to be significantly correlated with use of force decisions, offense seriousness, the number of officers onscene, suspect race, and suspect demeanor reversed were no longer significantly correlated when adjusted for publication bias. Even further caution should be taken when considering these variables as correlates of force decision-making."

[An Empirical Analysis of Racial Differences in Police Use of Force](https://scholar.harvard.edu/fryer/publications/empirical-analysis-racial-differences-police-use-force)

-   Finds that blacks and hispanics are disproportionately likely to experience both lethal and non-lethal use of force 

-   Controlling for variables which take into account context and civilian behavior does not fully explain the disparity in non-lethal use of force, but does fully explain the lethal use of force disparity.

[Roland Fryer is wrong: There is racial bias in shootings by police](https://scholar.harvard.edu/jfeldman/blog/roland-fryer-wrong-there-racial-bias-shootings-police)
...
[The Police Officer's Dilemma: A Decade of Research on Racial Bias in the Decision to Shoot](http://www.csun.edu/~dma/Correll,%20Hudson,%20Guillermo,%20&%20Ma%20(2014).pdf)

-   Literature review

-   Finds that while police officers are affected by target race in some respects, they do not generally show a pattern of biased shooting, and this performance depends on the exercise of cognitive control, which allows officers to overcome the influence of stereotypes.

[The effect of suspect race on police officers' decisions to draw their weapons](https://www.tandfonline.com/doi/abs/10.1080/07418825.2020.1760331)

-   "Using 2017 use-of-force data from the Dallas Police Department, we modeled officers' decisions to draw their weapons as a function of suspect race and other suspect, officer, and incident characteristics. We benchmarked by limiting analyses to arrest and active aggression cases, thereby excluding interactions in which it was less likely suspects would have had weapons drawn against them. The key finding was that black suspects were no more or less likely to have weapons drawn against them than other suspects."

[The Effects of Suspect Race and Situation Hazard on Police Officer Shooting Behavior](https://onlinelibrary.wiley.com/doi/abs/10.1111/j.1559-1816.1977.tb02415.x)

-   "fatalities are examined with respect to involvement in shooting and arrest rates. The results suggest an effect for degree of hazard; however, there was no evidence to suggest police bias against Blacks."

[A Bird's Eye View of Civilians Killed by Police in 2015](https://onlinelibrary.wiley.com/doi/abs/10.1111/1745-9133.12269)

-   "We analyzed 990 police fatal shootings using data compiled by The Washington Post in 2015."
...
<details markdown="1">
  <summary>Use of Force in General</summary>

**The evidence overall suggests that when accounting for the differential probability of arrest of black and white suspects there is a disparity in police use of force.**

[Lethal Force in Black and White: Assessing Racial Disparities in the Circumstances of Police Killings](https://www.journals.uchicago.edu/doi/10.1086/703541)
...
-   "[The models'] low prediction accuracy indicates that there are likely only marginal racial differences in the observable circumstances of police killings. Although African Americans are more likely to be killed by police, as a whole their lethal interactions are remarkably similar to those of white decedents." 

-   "On the other hand, these results do indirectly point to the probable source of the threefold racial difference in the rate of police killings. As previously discussed, the null result indicates that the racial disparity is most likely originating from the contact stage of the lethal interaction process. Because the analysis only examines incidents where a person was killed, it is not possible to confirm this conclusion quantitatively, but analytically it is improbable for there to be strong racial differences in either the interaction or trigger stage given the findings. As a result the most likely explanation for the difference in rates is that African Americans have more frequent contact with the police, leading to a higher risk of being killed by law enforcement."

[Police Use of Force as an Extension of Arrests: Examining Disparities across Civilian and Officer Race](https://www.aeaweb.org/articles?id=10.1257/pandp.20191028)

-   Finds that black civilians are more likely to be involved in a use of force incident during an arrest, but this stems from differences in initial likelihood of arrest.

[A Social Scientific Approach toward Understanding Racial Disparities in Police Shooting: Data from the Department of Justice (1980-2000)](https://spssi.onlinelibrary.wiley.com/doi/am-pdf/10.1111/josi.12243) 

-   Study of 213 metropolitan areas over a 21-year period

-   Finds that even after controlling for racial differences in criminal activity (a proxy for behavior), officers are still more likely to shoot black suspects
...
-   Finds that while there is a racial bias against white individuals with officers' probability to shoot and use lethal force, this is reversed when accounting for the racial disparity in probability of police encounter.
...
-   Finds that differences in circumstances do not explain the disparity between black and whites in police killings.

-   The standards in constitutional case law fail to anticipate the circumstances surrounding these types of interactions 

-   Enhanced police training appears to be ineffective, likely because it does not take into account the importance of race in officers' perceptions of risk and their decision-making.

[A Multi-Level Bayesian Analysis of Racial Bias in Police Shootings at the County-Level in the United States, 2011--2014](https://journals.plos.org/plosone/article?id=10.1371%2Fjournal.pone.0141854) 

-   Finds that racial bias is more likely to emerge in metropolitan areas with more black people and lower incomes, especially when there is high financial inequality in the county. 

-   There was no relationship between bias and crime rates, suggesting that differential crime rates do not explain this bias.

[On Racial Disparities in Recent Fatal Police Shootings](https://amstat.tandfonline.com/doi/pdf/10.1080/2330443X.2019.1704330?needAccess=true)

-   Finds that a racial disparity in shooting victims persists even after controlling for local population and arrest demographics.

-   There is no evidence that police-worn body cameras impact the racial distribution of victims.

**This disparity turns anti-white when controlling for crime. However, once disaggregating between armed criminals and unarmed innocent civilians, there is an anti-white bias against armed criminals and an anti-black bias against unarmed innocent civilians.**
...
-   Finds that looking at the racial disparity in shootings as a proportion of crime rather than population suggests that there is no racial disparity in fatal shootings by police.

[Considering violence against police by citizen race/ethnicity to contextualize representation in ](https://www.sciencedirect.com/science/article/abs/pii/S0047235219304398)

[officer-involved shootings](https://www.sciencedirect.com/science/article/abs/pii/S0047235219304398)

-   Finds that racial disparities in experiencing an officer-involved shooting are a function of racial differences in the propensity to engage in violence against police

[Racial Disparities in Police Use of Deadly Force Against Unarmed Individuals Persist After Appropriately Benchmarking Shooting Data on Violent Crime Rates](https://journals.sagepub.com/doi/pdf/10.1177/1948550620916071)

-   Responds to Cesario et al., 2019

-   Finds that when separating between armed criminals and unarmed non-criminals and then controlling for crime rates, there is an anti-white disparity for armed criminals, but there is an anti-black disparity for unarmed noncriminals

</details>

<details markdown="1">
  <summary>Effect of Officer Race</summary>

**There is no consistent evidence suggesting that officer race substantially affects police use of force.**

[Do White Law Enforcement Officers Target Minority Suspects](https://onlinelibrary.wiley.com/doi/epdf/10.1111/puar.12956)

-   Finds that although minority suspects are disproportionately killed by police, white officers appear to be no more likely to use lethal force against minorities than non-white officers.
...
-   Finds no racial disparity in shootings at all by officers

-   Officer race does not appear to affect this disparity

-   However, a retraction to the study states that this study does not say anything about whether there is a racial disparity in shootings at all by officers, only whether officer race has any effect.

[Making inferences about racial disparities in police violence](https://doi.org/10.1073/pnas.1919418117)

-   Response to above study

-   Points out that the disparity in shooting couldn't be calculated because it wasn't a per-capita estimate, it was only looking at the absolute number of shootings.

[Does Race Matter for Police Use of Force? Evidence From 911 Calls](https://www.nber.org/system/files/working_papers/w26774/w26774.pdf)

-   White officers increase use of force more than black officers when in minority neighborhoods, but not in white or mixed neighborhoods

-   Black and hispanic civilians are five times more likely to experience gun use of force by white officers compared to if white officers scaled up use of force similarly to black officers.

[Will more black cops matter? Officer race and police-involved homicides of black citizens](https://onlinelibrary.wiley.com/doi/epdf/10.1111/puar.12734)

-   While evidence is weak, the contradictions between studies may be due to the number of black police only mattering past an inflection point in which race-neutral norms are now internalized. Before that, the norms don't exist so more black cops won't solve racism in use of force.

</details>

<details markdown="1">
  <summary>Effect on Mental Health</summary>

**Exposure to more police killings of unarmed black Americans, which as demonstrated before is in part a product of racial bias, decreases the mental health of black Americans.**

[Police killings and their spillover effects on the mental health of black Americans: a population-based, quasi-experimental study](https://www.thelancet.com/journals/lancet/article/PIIS0140-6736(18)31130-9/fulltext)

-   Finds that increased exposure to more police killings of unarmed black Americans recently decreases the mental health of black americans.

Further Information:

[Across the Thin Blue Line: Police Officers and Racial Bias in the Decision to Shoot](https://pubmed.ncbi.nlm.nih.gov/17547485/)

[Impossibility of a "Reverse Racism" effect](https://onlinelibrary.wiley.com/doi/epdf/10.1111/1745-9133.12289)

[Does the "reverse racism effect" withstand the test of police officer fatigue?](https://sci-hub.ru/https://doi.org/10.1108/PIJPSM-01-2016-0006)

[Racial/Ethnic Disparities in the Use of Lethal Force by US Police, 2010--2014](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC5227943/pdf/AJPH.2016.303575.pdf)

[Results From Experimental Trials Testing Participant Responses to White, Hispanic and Black Suspects in High-Fidelity Deadly Force Judgment and Decision-Making Simulations](https://www.ojp.gov/ncjrs/virtual-library/abstracts/results-experimental-trials-testing-participant-responses-white)

[The Police Officer's Dilemma: Using Ethnicity to Disambiguate Potentially Threatening Individuals](https://www.researchgate.net/publication/10974305_The_Police_Officer's_Dilemma_Using_Ethnicity_to_Disambiguate_Potentially_Threatening_Individuals)

[Reply to Knox and Mummolo and Schimmack and Carlsson: Controlling for crime and population rates](https://www.pnas.org/doi/10.1073/pnas.1920184117)

[Mapping fatal police violence across US metropolitan areas: Overall rates and racial/ethnic inequities, 2013-2017](https://journals.plos.org/plosone/article?id=10.1371/journal.pone.0229686)

[An Empirical Analysis of Racial Differences in Police Use of Force: A Comment](https://www.journals.uchicago.edu/doi/full/10.1086/710976?casa_token=1XYXpSNkIl8AAAAA:gQmbOETjadJBUNj1ZY9d2r7HgnyFazj5VFoxaff23L3k4U2vHfp1wBWdk6DZrFWittx2znq8krjj)

[Deaths Due to Use of Lethal Force by Law Enforcement](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6080222/pdf/nihms-983593.pdf)

[Risk of Police-Involved Death by Race/Ethnicity and Place, United States, 2012--2018](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6085013/pdf/AJPH.2018.304559.pdf)

[How neighborhoods matter in fatal interactions between police and men of color](https://www.sciencedirect.com/science/article/abs/pii/S0277953618306580?via%3Dihub)

[The Factors that Motivate Law Enforcement's Use of Force: A Systematic Review](https://onlinelibrary.wiley.com/doi/epdf/10.1002/ajcp.12460?casa_token=2s_ZRYLJHIUAAAAA%3AS3dBkZ2f9yj_4PYnQ5hiEhfa3G8xTp-xaFyBuWPWsuEuK1fHrC3cAD9dExEhbfTsjedlVnE3ZqOX8Bo)
...
[Detecting Discrimination](https://www.jstor.org/stable/2646964?seq=1#metadata_info_tab_contents)
...
-   This suggests that evidence on racial discrimination operates under a false assumption that all black names are alike.
...
**There is evidence of mortgage discrimination occurring against blacks who have identical credit profiles, in terms of rejecting more profiles and having higher mortgage interest rates. Evidence as shown later suggests that this is due to statistical discrimination.**

[Racial Discrimination in the U.S. Housing and Mortgage Lending Markets: A Quantitative Review of Trends, 1976--2016](https://link.springer.com/article/10.1007/s12552-019-09276-x)

-   Looks at time series results from 16 field experiments of housing discrimination and 19 observational studies of mortgage lending discrimination

-   Finds evidence of a decline in housing discrimination from the late 1970s to the present

-   The decline is strongest for discrimination involving direct denial of housing availability, and weaker for measures reflecting the number of units recommended and inspected, and significant discrimination remains for these outcomes.

-   Racial gaps in loan denial have declined only slightly, and racial gaps in mortgage cost (interest rate) have not declined at all, suggesting persistent discrimination

[What's in a Picture? Evidence of Discrimination from Prosper.com](https://www.jstor.org/stable/25764804)

-   Finds that loan listings with blacks in the attached picture are 25-35% less likely than whites with similar credit profiles

[Racial discrepancy in mortgage interest rates](https://sci-hub.ru/https://doi.org/10.1007/s11146-014-9473-0)
...
[Discrimination in mortgage lending](https://ia601406.us.archive.org/32/items/cfljuly1995-95-pdf/cfljuly1995-95-pdf.pdf)

##IMAGE

[Blacks and Hispanics face extra challenges in getting home loans](https://www.pewresearch.org/fact-tank/2017/01/10/blacks-and-hispanics-face-extra-challenges-in-getting-home-loans/)

##IMAGE##IMAGE

**Even controlling for credit score, black people are more likely to default on their mortgage, meaning it makes sense to accept fewer applicants.**

[Race, redlining, and residential mortgage loan performance](https://sci-hub.ru/https://doi.org/10.1007/BF01099279)

-   "In terms of the race or ethnic background of the borrower, results indicate a higher likelihood of default on the part of black households (compared to white households), while Hispanic, Asian, and American Indian or Alaskan native households are, for the most part, statistically indistinguishable from white borrowers with respect to default risk."

[Report to the Congress on Credit Scoring and Its Effects on the Availability and Affordability of Credit](https://www.federalreserve.gov/boarddocs/rptcongress/creditscore/creditscore.pdf)

-   "Consistently, across all three credit scores and all five performance measures, blacks, single individuals, individuals residing in lower-income or predominantly minority census tracts show consistently higher incidences of bad performance than would be predicted by the credit scores."

-   "The data also track the performance difference for each loan category by creditscore group. In almost every category, blacks show a higher incidence of default than non-Hispanic white borrowers, although differences are, in some cases, small. However, two product areas, auto loans from finance companies and credit card loans, show consistently higher and larger default rates for blacks than for non-Hispanic white borrowers for all credit-score quintiles."

**As for mortgage costs, these completely go away when accounting for differences in discount points, which black borrowers pay fewer of. On net, mortgage costs appear to be identical.**

[Do Minorities Pay More for Mortgages?](https://academic.oup.com/rfs/article/34/2/763/5827007#226627786)

-   Finds gaps by race and ethnicity in interest rates which are offset by differences in discount points

-   Black and hispanic borrowers pay fewer discount points

-   Black and hispanic borrowers face a point rate schedule equal to that of white borrowers, although they sort to different locations on that schedule

-   "In other words, lenders compensate minority and white borrowers equally when they select a higher interest rate, across the entire range of interest rates."

-   There were no differences in total fees by race or ethnicity

**Further evidence that whatever discrimination occurs is statistical discrimination comes from the fact that profits are equal or less from black borrowers compared to white borrowers, suggesting that black people are not being systematically disadvantaged from the lending policy.**

[What's in a Picture? Evidence of Discrimination from Prosper.com](https://www.jstor.org/stable/25764804)

-   While loan discrimination occurs against blacks, lenders still earn a lower net return for loans to blacks compared to loans to whites

##IMAGE

[Do Minorities Pay More for Mortgages?](https://academic.oup.com/rfs/article/34/2/763/5827007#226627786)

-   Lenders were found to earn slightly higher revenue and higher profit on mortgages from minorities people, but not because the lenders charged higher prices to minority borrowers but because they are able to extract higher margins from borrowers regardless of race and ethnicity who want lower upfront costs.

Further Information:

[REDLINING AND MORTGAGE LENDING IN SACRAMENTO](https://www.tandfonline.com/doi/abs/10.1111/j.1467-8306.1979.tb01253.x)

[Mortgage Lending in Boston: Interpreting HMDA Data](https://www.bostonfed.org/publications/research-department-working-paper/1992/mortgage-lending-in-boston-interpreting-hmda-data.aspx)

[Mortgage Lending Discrimination: A Review of Existing Evidence Mortgage Lending](https://www.urban.org/sites/default/files/publication/66151/309090-Mortgage-Lending-Discrimination.PDF)

[HOUSING DISCRIMINATION AGAINST RACIAL AND ETHNIC MINORITIES 2012](https://www.huduser.gov/portal/Publications/pdf/HUD-514_HDS2012.pdf)

[Redlining, the Community Reinvestment Act, and private mortgage insurance](https://sci-hub.ru/https://doi.org/10.1016/S0094-1190(02)00508-9)

</details>

<details markdown="1">
  <summary>Rental Discrimination</summary>

**There is also discrimination in the rental housing market, although it appears that much of it is due to statistical discrimination as well.**

[Closed doors everywhere? A meta-analysis of field experiments on ethnic discrimination in rental housing markets](https://www.tandfonline.com/doi/full/10.1080/1369183X.2018.1489223)

-   "this article provides a quantitative meta-analysis of field experiments (in person audits and correspondence tests) that were run over the last four decades in the United States, Canada and Europe (N = 71). Special focus is given to a possible inflation of effect sizes by publication bias; to time trends; and to evidence for statistical discrimination. Taken together, nearly all experiments document the occurrence of ethnic discrimination. Effect sizes are inflated by publication bias, but there is still substantial evidence left once the bias is removed. The analysis reveals a consistent decline in the extent of discrimination over time, from moderate levels of discrimination in the 1970s and 1980s, up to only small but still statistically significant levels in the 1990s and 2000s. A significant part of the discriminatory behaviour can be attributed to missing information about the social status of applicants, which supports theories on statistical discrimination."

**Experimental research does show that race affects a person's ability to view apartments, independent of voucher status.**

[Qualified Renters Need Not Apply Race and Voucher Discrimination in the Metro Boston Rental Housing Market](https://www.suffolk.edu/-/media/suffolk/documents/news/2020/law-news/rental_housing_study_july2020.pdf?la=en&hash=B0FFF5916ECA23DFD054170DA223780EDA571241)

-   Looks at how race and voucher status affects people's ability to view apartments

-   Finds that substantial discrimination exists, which primarily negatively affects black people
...
[Trends in Suicide Rates by Race and Ethnicity in the United States](https://jamanetwork.com/journals/jamanetworkopen/fullarticle/2780380)
...
-   Model minority stereotype is that Asians are smart, wealthy, industrious, docile, and independent
...
<details markdown="1">
  <summary>In College: Effect on Minority Admissions</summary>

**The evidence suggests that affirmative action in universities has positive effects on minority admissions. This effect is stronger in more elite-level schools. This does come at the expense of some whites, but minority populations in these schools are still relatively small so this discrimination effect is relatively small as well.**

[Does Affirmative Action Work? Caste, Gender, College Quality, and Academic Success in India](https://www.aeaweb.org/articles?id=10.1257/aer.20140783)

-   "We study the effects of one such affirmative action program: an admissions policy that fixes percentage quotas, common across more than 200 engineering colleges, for disadvantaged castes and for women. We show that the program increases college attendance of targeted students, particularly at relatively higher-quality institutions."

[Understanding Affirmative Action](https://diversity.berkeley.edu/sites/default/files/understanding_affrirmative_action.pdf)

-   Literature review

-   Race-sensitive admissions policies significantly increased the numbers of African Americans admitted to and who attended schools

[Does Affirmative Action for Blacks Harm Whites? Some Evidence From the Higher Education Arena](https://go.gale.com/ps/i.do?p=AONE&u=googlescholar&id=GALE%7CA53744951&v=2.1&it=r&sid=googleScholar&asid=f46747c4)

-   Finds that minority representation in schools as a result of affirmative action gains have not come at the expense of whites, although in some cases has slowed down the white gains in numbers in university.

[The Effects of Affirmative Action Bans on College Enrollment, Educational Attainment, and the Demographic Composition of Universities](https://www.jstor.org/stable/23261474?searchText=&searchUri=&ab_segments=&searchKey=&refreqid=fastly-default%3A9999d33bbb0ee62950e23b72868c8010#metadata_info_tab_contents)
...
-   "the affirmative action ban in California shifted underrepresented minority students from more selective campuses to less selective ones at the University of California."

[Affirmative Action: What Do We Know?](https://www.jstor.org/stable/pdf/30162729.pdf?refreqid=excelsior%3Ab5df27a45b1892b4eddfe0f728629c58&ab_segments=&origin=)

-   Literature review

-   The impacts of affirmative action on the attendance of black and Hispanic students is small for the majority of colleges and universities but rises with the quality of the school and become substantial at elite schools

-   Still, blacks and hispanics have relatively low numbers at elite schools, so the displacement of whites is fairly small

[What if there was no Affirmative Action in College Admissions? A Further Refinement of our Earlier Calculations](https://www.jstor.org/stable/2962408)

[Racial and Ethnic Preferences at the Three Virginia Public Law Schools](https://www.ceousa.org/wp-content/uploads/2013/02/VALaw.pdf)

[Racial and Ethnic Admission Preferences at Arizona State University College of Law](https://www.ceousa.org/wp-content/uploads/2012/01/ASU_LAW.pdf)

-   Affirmative action exists in some law schools in the US and discriminates against white people in favor of minorities, often with lower LSAT scores and college GPAs.

</details>

<details markdown="1">
  <summary>In College: Effect on Minority Performance and Labor Market Effects</summary>

**While affirmative action undoubtedly does increase the admission of minorities into universities, there is debate about if this comes at the expense of minorities, who may suffer from being put into more difficult courses. This effect is known as mismatch. There is some research which suggests that mismatch occurs, with the most important study looking at law school affirmative action.**

[A Systemic Analysis of Affirmative Action in American Law Schools](https://www.jstor.org/stable/40040209)

The effects of affirmative action on academic performance in law school:

-   Table 5.2 shows that after controlling for prior LSAT scores and GPA, there is no statistically significant relationship between race and performance in law schools, meaning that LSAT and GPA are important over race in explaining grades.

-   Therefore, the poor performance of black students at law schools appears to be primarily a function of disparate entering credentials, which is explained by law schools' heavy use of racial preferences.

-   In fact, blacks are heavily concentrated among low performers in almost all law schools in the US, except for those that are historically minority law schools

-   Among black students who graduate law school, their grades slightly drop relative to everyone else.

-   Black students also tend to drop out more in law school. One study found that 8.2% of the white students, but 19.2% of the black students, who started law school in 1991 had not graduated by the end of the study 5 years later.

-   However, one could argue that black attrition could be lowered through racial preferences, as elite law schools have higher graduation rates than other law schools.

-   Law school eliteness independently of gpa predicts law school graduation, but gpa is a stronger predictor. Race alone isn't a predictor after controlling for these and several other factors, such as family income.

-   Therefore, those who receive preferences to go to more elite law schools derive some benefit from higher general graduation rates, but get much lower grades and thus on the balance, drop out more.

-   Racial preferences appear to have an effect equivalent to lowering the index of the typical black student by 60 to 80 points. This results in a high attrition disparity between blacks and whites.

Conclusion

-   The main advantage of affirmative action is that it increases the number of black students in law schools in general and also prestigious law schools. However, they are as a whole disadvantaged when affirmative action is in place, with lower GPAs and higher attrition.

-   As a consequence, blacks are less likely than whites to pass state bar exams after multiple attempts. However, when they do pass the bar, they have a slight earning advantage than whites seeking similar jobs with similar credentials likely due to racial preferences in hiring.

-   When taking into account the negative effects of affirmative action on graduation and passing the bar, affirmative action probably tends to decrease the number of new black lawyers.

-   Note: Assumes effects of GPA and SAT on school performance are uniform for races

**Unfortunately, this study has the problem of presupposing in their regression models that the effect of GPA and SAT performance is uniform for races. When not looking at average effects, a different picture is painted in which prior performance is less of a predictor of future performance for black people. Moreover, the effect of school selectivity on performance is negative for the general population, but looking specifically at black people it positively predicts performance.**

[Does Affirmative Action Work? Caste, Gender, College Quality, and Academic Success in India](https://www.aeaweb.org/articles?id=10.1257/aer.20140783)

-   "We study the effects of one such affirmative action program: an admissions policy that fixes percentage quotas, common across more than 200 engineering colleges, for disadvantaged castes and for women."

-   "An important concern is that affirmative action might harm intended beneficiaries by placing them in academic programs for which they are ill-prepared. We find no evidence of such adverse impacts."

[Understanding Affirmative Action](https://diversity.berkeley.edu/sites/default/files/understanding_affrirmative_action.pdf)

-   Literature review

-   Those admitted as a result of race-sensitive admissions policies graduated at the same rate as white students

-   This was all shown by a study which analyzed over 80,000 students who had matriculated at 28 elite colleges and universities in 1951, 1976, and 1989.

-   Colleges and universities cannot achieve ethnic diversity if class representation is the only factor represented

-   One study did suggest that minority attrition increased following affirmative action (The study a systematic analysis of affirmative action in American law schools), but the study assumed that the relationship between initial grades and law school grades are the same among black students as white students, which is false, among other issues.

[Affirmative Action: What Do We Know?](https://www.jstor.org/stable/pdf/30162729.pdf?refreqid=excelsior%3Ab5df27a45b1892b4eddfe0f728629c58&ab_segments=&origin=)

-   Literature review

-   If it is the case that affirmative action in admissions is allowing less qualified minorities to enter more selective schools, their grades relative to whites would drop as college selectivity rose, and their dropout rates would be higher at such schools, especially for minority students with the lowest relative SAT scores.

-   For blacks, the evidence suggests that college selectivity improves graduation rates, but negative effects for the general population, so therefore affirmative action in university generates no harm and probably some gains in graduation rates and later earnings for minorities who attend more elite colleges and universities.

-   Law school quality conditional on college grades and LSAT scores increases rather than decreases bar passage and graduation rates in law schools for blacks

**The mismatch effect could still nonetheless occur for some especially unqualified black candidates. I would need to do more research before I felt confident about this issue specifically, but it is certainly possible that in the United States, affirmative action is so extreme that it is suboptimal for advancing educational outcomes for minorities.**

[Affirmative Action: What Do We Know?](https://www.jstor.org/stable/pdf/30162729.pdf?refreqid=excelsior%3Ab5df27a45b1892b4eddfe0f728629c58&ab_segments=&origin=)

-   Literature review

-   Mismatch could exist for a subset of especially unqualified black candidates, and the degree to which affirmative action is too much or too little in the US is up for debate.

[Affirmative Action and the Quality-Fit Tradeoff](https://www.nber.org/system/files/working_papers/w20962/w20962.pdf)

-   "The literature clearly shows positive average effects of college quality on a host of outcomes. This suggests that mild racial preferences will have a positive impact on minority outcomes. The issue is whether racial preferences in their current form are so strong that mismatch effects may arise."
...
**Importantly, mismatch effects presuppose either that students' enrollment decisions are irrational or that selective universities possess private information which affects school performance. There is some evidence for the latter, meaning if we presuppose that the former assertion is true, making such information more public could decrease mismatch effects where they exist.**

[Does affirmative action lead to mismatch? A new test and evidence](https://onlinelibrary.wiley.com/doi/abs/10.3982/QE83)

-   "We argue that once we take into account the students' rational enrollment decisions, mismatch in the sense that the intended beneficiaries of affirmative action admission policies are made worse off ex ante can only occur if selective universities possess private information."

-   "Ex ante mismatch occurs when revelation of this information would have changed the student's choice of school. This necessary condition for mismatch provides the basis for a new test. The test is implemented using data from the Campus Life and Learning Project at Duke University. Evidence shows that Duke does possess private information that is a statistically significant predictor of students' post-enrollment academic performance. Further, this private information is shown to affect the subjective measures of students' satisfaction as well as their persistence in more difficult majors."

**Much of the research above on the subject suggests that the positive effects of affirmative action on minority performance translates into positive labor market effects downstream. There is some research which suggests otherwise, but this suffers from the same problem as another study mentioned before in that it assumes uniform effects of prior performance on future performance for racial groups.**

[Affirmative Action in Higher Education](https://www.jstor.org/stable/pdf/2117647.pdf?refreqid=excelsior%3A42e0ed4c8fa818183614196a852973f5&ab_segments=&origin=)

-   Finds that holding performance constant, blacks gain more in subsequent earnings from attending selective colleges than whites, but this may be offset by performance as a result of affirmative action.

-   Moreover, colleges with a median SAT score above 1100 have no higher returns to education than colleges with one between 1000-1099, meaning that affirmative action may lower black students' earnings if they perform worse in more selective schools.
...
<details markdown="1">
  <summary>In College: Student Diversity and School Performance</summary>

**There also appears to be positive externalities derived from the increased student diversity created as a consequence of affirmative action. Most notably, it appears to improve school performance for all groups in general, meaning that affirmative action can cause boosts for non-minority students who aren't discriminated against.**

[The Case for Affirmative Action](https://www.gse.harvard.edu/news/uk/18/07/case-affirmative-action)
...
-   Diversity results in an increased ability to take perspective of others and increased involvement in political affairs.

-   Cross-ethnic interactions and participation in diversity courses benefits both whites and people of color

-   Studies have also found enhanced cognition results from improved diversity

[Affirmative Action: What Do We Know?](https://www.jstor.org/stable/pdf/30162729.pdf?refreqid=excelsior%3Ab5df27a45b1892b4eddfe0f728629c58&ab_segments=&origin=)

-   Literature review

-   Diversity in colleges and universities are associated with various learning and "democracy" outcomes amongst all race or ethnic groups, although arguments about causality potentially undermine these results, as for example those who are growing intellectually might be more likely to go to diverse spaces as they're more culturally aware.

-   Some experimental data however does confirm this effect probably exists.

</details>

<details markdown="1">
  <summary>Opinion and Psychology</summary>

**There are many explanatory factors involved in support and opposition to affirmative action. Racial prejudice or concerns about justice can predict opposition. On the other hand, white guilt can predict support.**

[Racial Prejudice and Attitudes Toward Affirmative Action](https://www.jstor.org/stable/2111770)

-   Finds that while racial prejudice explains some of the opposition to affirmative action, it doesn't explain all of it, and many whites who strongly resist affirmative action believe in making extra efforts to help African Americans.

[Opposition to Affirmative Action: Racial Affect and Traditional Value Predictors Across Four Programs](https://onlinelibrary.wiley.com/doi/abs/10.1111/j.1559-1816.1995.tb02394.x)

-   Examines the nature of opposition to affirmative action

-   "Research on white opinions of such compensatory policies as busing and affirmative action has suggested that prejudice is the primary determinant of policy attitudes (Jacobson, 1985; McConahay, 1982). Often, however, racism is measured in a manner that confounds prejudice with values and concerns about justice."

-   "We found that: (a) support varied considerably across programs and was greater when implementation was imminent; (b) separate operationalizations of race prejudice and dispositional justice beliefs accounted for equal, and at times greater, variance in affirmative action opinions relative to a measure of symbolic racism; and (c) correlates of policy endorsement, including dispositional justice beliefs but not racial affect, varied from program to program."

-   "It is also suggested that justice concerns, particularly regarding policy specifics, are important predictors of affirmative action attitudes that to date have largely been overlooked."

[White Guilt: Its Antecedents and Consequences for Attitudes Toward Affirmative Action](https://journals.sagepub.com/doi/abs/10.1177/0146167299025004008)

-   White guilt mediated the relationship from white privilege and beliefs about the prevalence of discrimination to attitudes toward affirmative action, and both white guilt and prejudice independently predicted attitudes toward affirmative action.

**Mentions of affirmative action can lead people to view groups who benefit from affirmative action more negatively.**

[The Social Consequences of Affirmative Action: Deleterious Effects on Perceptions of Groups](https://journals.sagepub.com/doi/10.1177/0146167298241005)
...
[Pierson et al. (2020)](https://5harad.com/papers/100M-stops.pdf?utm_source=The+Appeal&utm_campaign=3a050d7014-EMAIL_CAMPAIGN_2018_08_09_04_14_COPY_01&utm_medium=email&utm_term=0_72df992d84-3a050d7014-58394763) analyzed nearly 100 million traffic stops across the US and found that black drivers are less likely to be stopped after sunset when a veil of darkness clouds one's face. This suggests bias in stop decisions. There are other studies however which have found no indication of racial bias when using a veil of darkness test [(Grogger & Ridgeway, 2006;](https://amstat.tandfonline.com/doi/abs/10.1198/016214506000000168?casa_token=TyYOszQOPsAAAAAA%3Ab6D7UhNTlyYCsRYT6u-6uQOdudvgFJF89H-0l95JvtDeCTC1PFdLlfkD9MKGseeG3GUI81eW71os&#.YjKDGurMI2y)  [Worden et al., 2012)](https://sci-hub.ru/https://doi.org/10.1177/1098611111433027). [Horrace & Rohlin (2016)](https://sci-hub.ru/https://doi.org/10.1162/REST_a_00543) attempts to address Grogger and Ridgeway by refining their test through controlling for streetlight locations as opposed to simply looking at daylight versus nighttime. They find that after controlling for this the odds of a black driver being stopped relative to nonblack drivers increase 15% in daylight compared to darkness, suggesting bias.

The racial composition of speeders differs from that of non speeding drivers and closely approximates the racial composition of police stops, which suggests no racial profiling in traffic stops [(Lange et al., 2005;](https://sci-hub.ru/https://doi.org/10.1080/07418820500088952)  [Lundman & Kowalski, 2009)](https://www.ojp.gov/ncjrs/virtual-library/abstracts/speeding-while-black-assessing-generalizability-lange-et-als-2001).
